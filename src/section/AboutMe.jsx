...
const AboutMe = () => {
  return (
    <div id="AboutMe" className=" flex flex-col items-center  rounded-2xl  bg-gray-50">
      <h2 className="font-bold text-black text-center  text-4xl sm:text-5x mt-20 mb-6">AboutMe</h2>
      <p className=" text-black text-center max-w-3xl text-lg mt-10">
      ...
      <h3 className="font-semibold text-black text-center mt-10 text-2xl">Projects</h3>
      ...
      <h3 className="font-semibold text-black text-center mt-10 text-2xl">Future Goals</h3>
      <p className="mt-6 text-black text-center max-w-3xl text-lg">
